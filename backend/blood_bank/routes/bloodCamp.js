...
router.put('/:campId/donor/:donorId', auth.doctorAuth, campController.updateDonorStatus);
...
router.post('/:campId/register', auth.patientAuth, campController.registerForCamp);
