...
useEffect(() => {
  async function fetchPatientData() {
    try {
      ...
      setPatientData(res.data.data); // entire patient object with email
    } catch (err) {
  ...
  date: formData.date,
  price: doctors.find(d => d._id === formData.doctorId)?.feePerConsultation || 500,
});
if (appointmentDetails) {
  console.log("Appointmnet Detailsssssss",appointmentDetails);
