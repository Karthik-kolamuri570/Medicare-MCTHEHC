...
//     [...new Set(doctors.map(d => d.location).filter(Boolean))].sort(),
//     [doctors]
//   );
...
//   // Handler functions - optimized to prevent focus loss
//   const handleInputChange = useCallback((e) => {
//     const { name, value } = e.target;
//     setFormData(prev => ({ ...prev, [name]: value }));
//   },[]);

//   // Direct search handler - no debouncing to make it feel more responsive
...
//   const handleChange =useCallback( (e) => setFormData({ ...formData, [e.target.name]: e.target.value }),[]);
...
//                 <input value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} placeholder="Search doctors, specialty or location" aria-label="Search doctors" 
//               // { <button type="button" className="clear" onClick={() => setSearchQuery("")}><FiX /></button>}
//                 // value={searchQuery}
...
//   const DoctorCard = React.memo(({ doctor, isSelected, onSelect }) => {
...
//   const FilterSidebar = () => {
//     return (
//       <aside className={`filter-sidebar ${showFilters ? 'expanded' : 'collapsed'}`}>
...
//                   onSelect={() => setFormData(prev => ({ ...prev, doctorId: doctor._id }))}
//                 />
//               ))
//             )}
//           </div>
...
//     return <div className="step-panel">{renderStepContent()}</div>;
//   };

//   // Summary Sidebar Component
//   const SummarySidebar = () => {
//     const selectedDoctor = doctors.find(d => d._id === formData.doctorId);
//     const consultationFee = selectedDoctor?.feePerConsultation || 0;
...
//   // Toast Component
//   const Toast = ({ type, message, onClose, autoClose = true }) => {
//     useEffect(() => {
//       if (autoClose) {
...
//       {/* Enhanced Styles with Better Search Experience */}
//       <style jsx>{`
...
//   // FIXED: Single search handler - no duplicate handlers
...
//             <div className="search-container">
//               <FiSearch className="search-icon" />
//               {/* FIXED: Single input with one handler */}
//               <input
//                 ref={searchInputRef}
//                 type="text"
//                 className="search-input"
...
//   // Stable onChange handler for search input - single handler, memoized
//   const handleSearchInputChange = useCallback((e) => {
//     setSearchQuery(e.target.value);
//   }, []);
