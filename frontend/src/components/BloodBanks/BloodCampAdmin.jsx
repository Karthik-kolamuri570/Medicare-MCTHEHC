...
//     try {
//       if (editCamp) {
//         // Use updated route with "/update-camps/:id"
...
//     try {
//       // Use updated route with '/delete-camp/:id'
...
//       {alert.msg && (
//         <div style={{
//           background: alert.type === "success" ? "#dbffe6" : "#ffe3e3", color: alert.type === "success" ? "#26703b" : "#a10000",
//           padding: "12px 18px", borderRadius: 12, fontWeight: 600, margin: "12px 0", maxWidth: 480
//         }}>{alert.msg}</div>
//       )}
...
//           <span style={styles.statNumber}>{camps.length}</span>
//           <span style={styles.statLabel}>Total Camps</span>
//         </div>
//         <div style={styles.statCard}>
//           <span style={styles.statNumber}>
//             {camps.reduce((acc, camp) => acc + (camp.donors?.length || 0), 0)}
//           </span>
//           <span style={styles.statLabel}>Total Donors</span>
//         </div>
//         <div style={styles.statCard}>
//           <span style={styles.statNumber}>
//             {camps.reduce((acc, camp) => acc + (camp.volunteers?.length || 0), 0)}
//           </span>
...
//             </div>
//             <div style={{ fontSize: 14 }}>{camp.location?.address}, <span style={{ color: "#666" }}>
//               {camp.location?.city}, {camp.location?.state}</span>
//             </div>
...
//           <form onSubmit={handleCreateOrEdit} style={styles.modalCard}>
//             <h2 style={{fontWeight:900, color:"#a00", marginBottom:10}}>{editCamp ? "Edit" : "Organize"} Blood Camp</h2>
//             <input required placeholder="Camp Name" value={form.name}
...
//                 style={styles.inputSmall} />
//             </div>
//             <input required placeholder="Address" value={form.location.address}
//               onChange={e => handleFormChange(e, "location.address")}
//               style={styles.input} />
//             <input placeholder="City" value={form.location.city}
//               onChange={e => handleFormChange(e, "location.city")}
//               style={styles.input} />
//             <input placeholder="State" value={form.location.state}
//               onChange={e => handleFormChange(e, "location.state")}
//               style={styles.input} />
//             <input placeholder="Country" value={form.location.country}
//               onChange={e => handleFormChange(e, "location.country")}
//               style={styles.input} />
//             <input placeholder="Pincode" value={form.location.pincode}
//               onChange={e => handleFormChange(e, "location.pincode")}
//               style={styles.input} />
//             <div style={{display:"flex",gap:10,marginTop:6}}>
//               <input placeholder="Latitude" value={form.location.geo.lat}
//                 onChange={e => handleFormChange(e, "location.geo.lat")}
//                 style={styles.inputSmall}/>
//               <input placeholder="Longitude" value={form.location.geo.lng}
//                 onChange={e => handleFormChange(e, "location.geo.lng")}
//                 style={styles.inputSmall}/>
//             </div>
//             <textarea placeholder="Description" value={form.description}
//               onChange={e => setForm(f => ({ ...f, description: e.target.value }))}
//               rows={2} style={styles.input} />
...
//               <button style={styles.greenBtn}>{editCamp ? "Update" : "Create"} Camp</button>
...
// const styles = {
//   bg: { minHeight: "100vh", background: "linear-gradient(120deg,#fa8181 0%, #ffe6e6 100%)", padding: 0 },
//   header: {
//     display: "flex", alignItems: "center", justifyContent:"space-between", padding:"32px 8vw 10px 8vw", background: "linear-gradient(120deg,#c41e3a 0%, #fa8181 100%)", marginBottom: 14
//   },
//   logo: { fontSize: 33, letterSpacing: 2, fontWeight: 700, textShadow: "0 1px 4px #fff2" },
//   addBtn: {
//     background: "#fff", color: "#c41e3a", fontWeight: 700, border: 0, padding: "11px 32px", borderRadius: 24,
//     fontSize: 16, boxShadow: "0 2px 8px #eee", cursor: "pointer"
//   },
//   statsGrid: {
//     display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(150px,1fr))", gap: 22, margin: "2vh 8vw"
//   },
//   statCard: {
//     background: "linear-gradient(95deg,#fff5ef 20%,#fde3e3 80%)",
//     boxShadow: "0 2px 12px #f6cccc", padding: "22px 0", borderRadius: 16, textAlign: "center"
//   },
//   statNumber: { fontSize: 34, fontWeight: 800, color: "#c41e3a" },
//   statLabel: { fontSize: 15, color: "#880000", fontWeight: 700 },
//   campGrid: {
//     display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(330px,1fr))", gap: 24, margin: "24px 8vw"
//   },
//   campCard: {
//     background: "#fff", borderRadius: 16, boxShadow: "0 2px 24px #eeb4b44d", padding: 24,
//     marginBottom: 10, position: "relative", minHeight: 160
//   },
//   cardTitleRow: { display: "flex", justifyContent: "space-between", alignItems: "center" },
//   datePill: {
//     background:"#fff7f1", color:"#b00", padding:"2px 9px", fontWeight:700, borderRadius: 8, fontSize:14, margin:"0 2px"
//   },
...
//   editBtn: {
//     background: "#e7f6ee", color: "#048152", border: 0, borderRadius: 24,
//     fontWeight:700, padding:"6px 20px", cursor:"pointer"
//   },
//   deleteBtn: {
//     background: "#ffe3e3", color: "#a10000", border: 0, borderRadius: 24,
//     fontWeight:700, padding:"6px 20px", cursor:"pointer"
//   },
//   overlay: {
...
//   },
//   modalCard: {
//     background: "#fff", borderRadius: 14, padding: "28px 30px", boxShadow: "0 3px 32px #b8000027",
//     minWidth: 340, maxWidth: 440
//   },
//   input: {
//     width: "100%", marginBottom: 10, padding: "8px 10px", borderRadius: 7, border: "1px solid #edd",
//     fontSize:16, fontWeight:500
//   },
//   inputSmall: {
//     width: "48%", marginBottom: 10, padding: "8px 10px", borderRadius: 7, border: "1px solid #edd",
//     fontSize:16, fontWeight:500
//   },
//   greenBtn: {
//     background:"linear-gradient(90deg,#38ef7d 30%,#11998e 100%)", color:"#fff", fontWeight:700,
//     border:0, borderRadius:23, padding:"8px 24px", fontSize:15, boxShadow:"0 0px 10px #efefef"
//   },
//   outlineBtn: {
//     background:"#fff", color: "#c41e3a", border:"1.5px solid #e1b4b4",
//     fontWeight:700, borderRadius:23, padding:"8px 24px", fontSize:15
//   }
// }
