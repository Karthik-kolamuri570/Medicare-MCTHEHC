...
//           "http://localhost:1600/api/doctor/get-second-opinion",
//           { withCredentials: true }
//         );
//         setRequests(res.data?.data || []);
//       } catch (err) {
//         console.error(err);
//         alert("Could not load second opinion requests.");
//       } finally {
//         setLoading(false);
//       }
//     }
...
//       <div className="p-8">
//         <h2 className="text-xl font-semibold mb-6">Get Second Opinion</h2>

//         {requests.map((req) => (
//           <div
//             key={req._id}
//             className="flex justify-between gap-8 border border-gray-300 rounded-xl p-6 mb-6 bg-white shadow-md"
//           >
//             <div className="flex-1 space-y-1">
//               <p>
//                 <strong>Patient Name:</strong> {req.patientId.name}
//               </p>
//               <p>
//                 <strong>Problem:</strong> {req.problem}
//               </p>
//               <p>
//                 <strong>Availability:</strong> {req.date} - {req.time}
//               </p>
//               <p>
//                 <strong>Mode:</strong> {req.mode}
//               </p>
//               <p>
//                 <strong>Phone or Email:</strong> {req.patientId.contact}
//               </p>
//               <p>
//                 <strong>Files and Medical Records:</strong>{" "}
//                 {req.files?.join(", ")}
//               </p>
//               <p>
...
//             No more second opinion requests.
//           </p>
//         )}
//       </div>
//     </div>
...
export default function DSecondOpinions() {
  ...
  if (loading) {
    return <div className="flex justify-center items-center min-h-[600px] bg-slate-50"><p>Loading Requests...</p></div>;
  }
